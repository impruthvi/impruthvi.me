...
> **Note:** I wrote a better version of this story. The real reason I built laramail isn't provider switching — it's `Mail.fake()`. Read the updated post: [I got tired of janky nodemailer mocks on every project](/posts/i-got-tired-of-janky-nodemailer-mocks)
...
- [Documentation](https://laramail.impruthvi.me) — full API reference
